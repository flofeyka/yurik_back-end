...
export class StepController {
  ...
  async getStep(
    ...
    return await this.stepService.getStep(
      request.agreement,
      stepId,
      request.user.id,
    );
  ...
  @Put('/:stepId/complete')
  async completeStep(@Req() request: RequestType): Promise<AgreementStepDto> {
  ...
  async changeOrder(
    @Req() request: RequestType,
    @Body() stepsDto: ChangeOrder,
  ): Promise<AgreementDto> {
    return this.stepService.changeStepsOrder(
      request.agreement,
      stepsDto,
      request.user.id,
    );
